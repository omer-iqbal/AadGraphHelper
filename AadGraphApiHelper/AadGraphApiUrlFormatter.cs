...
{
    internal class AadGraphApiUrlFormatter : IGraphApiUrlFormatter
    {
        public string FormatUrl(GraphApiUrlBuilder builder)
        {
            ...
            uriBuilder.Path = builder.TenantCredential.Tenant + '/' + builder.ResourceFirst;
            ...
            queryPairs["api-version"] = builder.ApiVersion;
